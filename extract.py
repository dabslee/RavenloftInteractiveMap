...
LEVELS = [
    dict(id="walls", name="Walls of Ravenloft", heading="Walls of Ravenloft",
         dm="References/img/map_packs/default/map-4.02-walls.webp",
         player="References/img/map_packs/default/map-4.02-walls-player.webp",
         w=3840, h=5211, grid=87.37, offx=1.59, offy=77.97, elev=0),
    dict(id="main", name="Main Floor", heading="Main Floor",
         dm="References/img/map_packs/default/map-4.03-main-floor.webp",
         player="References/img/map_packs/default/map-4.03-main-floor-player.webp",
         w=3000, h=2072, grid=86.51, offx=32.16, offy=1.53, elev=0),
    dict(id="court", name="Court of the Count", heading="Court of the Count",
         dm="References/img/map_packs/default/map-4.04-court-revised.webp",
         player="References/img/map_packs/default/map-4.04-court-player-revised.webp",
         w=5560, h=3840, grid=160.46, offx=55.89, offy=1.2, elev=50),
    dict(id="weeping", name="Rooms of Weeping", heading="Rooms of Weeping",
         dm="References/img/map_packs/default/map-4.05-weeping.webp",
         player="References/img/map_packs/default/map-4.05-weeping-player.webp",
         w=3000, h=2072, grid=85.83, offx=42.64, offy=8.73, elev=90),
    dict(id="spires", name="Spires of Ravenloft", heading="Spires of Ravenloft",
         dm="References/img/map_packs/default/map-4.06-spires12.webp",
         player="References/img/map_packs/default/map-4.06-spires12-player.webp",
    ...
    dict(id="larders", name="Larders of Ill Omen", heading="Larders of Ill Omen",
         dm="References/img/map_packs/default/map-4.08-larders.webp",
         player="References/img/map_packs/default/map-4.08-larders-player.webp",
    ...
    dict(id="dungeon", name="Dungeon and Catacombs", heading="Dungeon and Catacombs",
         dm="References/img/map_packs/default/map-4.09-dungeons-and-catacombs.webp",
         player="References/img/map_packs/default/map-4.09-dungeons-and-catacombs-player.webp",
